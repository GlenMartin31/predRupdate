...
[![metacran downloads](https://cranlogs.r-pkg.org/badges/grand-total/predRupdate)](https://cran.r-project.org/package=predRupdate)
<!-- badges: end -->
...
## Getting help
If you encounter a bug, please file an issue with a minimal reproducible example on [GitHub](https://github.com/GlenMartin31/predRupdate).
